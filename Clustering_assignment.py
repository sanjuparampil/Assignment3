...
data_GDP= df_GDP.drop(columns=["Country Code","Indicator Name","Indicator Code"])
...
data_GDP = data_GDP.drop(columns={"Country Name","Country Code","Indicator Name","Indicator Code"})
...
# # fit exponential growth
popt, covar = opt.curve_fit(exp_growth, GDP_tr["year"],GDP_tr["JAPAN"], p0=[4e8, 0.02])
# # much better
print("Fit parameter", popt)
GDP_tr["pop_exp"] = exp_growth(GDP_tr["year"], *popt)
plt.figure()
